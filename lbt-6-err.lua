...
file that describes a template should have at the bottom:
  ...
  return {
    ...
    posargs = <table of arg specs>,        # can be omitted
    opargs = <list of option specs> # can be omitted
  }
...
lbt.err.E192_oparg_lookup_failed = function (opcode, oparg)
  DEBUGGER()
...
lbt.err.E193_oparg_lookup_for_macro_failed = function (key)
  E('E193 Attempt to resolve oparg in a macro failed.  key: %s', key)
end
